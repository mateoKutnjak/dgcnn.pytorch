...
def train(args, io):
    train_loader = DataLoader(CustomS3DIS(partition='train', num_points=args.num_points, test_area=args.test_area), 
                              num_workers=8, batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(CustomS3DIS(partition='test', num_points=args.num_points, test_area=args.test_area), 
...
def test(args, io):
    ...
    for test_area in range(1,7):
        ...
        if (args.test_area == 'all') or (test_area == args.test_area):
            test_loader = DataLoader(CustomS3DIS(partition='test', num_points=args.num_points, test_area=test_area),
